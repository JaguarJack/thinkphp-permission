 ...
 * @method  static  \think\permissions\model\Roles updateBy($role_id, $data) update by id
 * @method  static  \think\permissions\model\Roles getPermissions($role_id, $full) get Permissions Of Role
 * @method  static  \think\permissions\model\Roles attachPermissions($role_id, $permission) attach permissions to Role
 * @method  static  \think\permissions\model\Roles detachPermissions($role_id) detach permissions of Role
 * @method  static  \think\permissions\model\Roles detachUsers($role_id, $user = null) detach permissions of User
 */
